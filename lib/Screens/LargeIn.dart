...
class Lin extends StatefulWidget {
  @override
  _LinState createState() => _LinState();
}
          ...
          Column(
            ...
            children: [
              Container(
                ...
                child: Image(image: AssetImage("images/largeintenstine.png"),fit: BoxFit.fill,),
              ),
              SizedBox(height: 10,),
              ...
              Padding(
                ...
                child: Container(
                  child: Card(
                    color: Colors.red,
                    child: Center(
                      child: Text("\nColorectal Cancer, Ulcerative colitis,Diverticulitis,Imitable bowel Syndrome .\n",style:
                      TextStyle(
                          color: Colors.white
                      ),
                  ...
                  items: [
                    Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        image: DecorationImage(
                          image: ExactAssetImage('images/li_one.png'),
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        borderRadius: BorderRadius.circular(8.0),
                        image: DecorationImage(
                          image: ExactAssetImage('images/li_two.png'),
                          fit: BoxFit.scaleDown,
                        ),
                      ),
                    ),
                    Container(
                      ...
                      decoration: BoxDecoration(
                        borderRadius: BorderRadius.circular(8.0),
                        image: DecorationImage(
                          image: ExactAssetImage('images/li_three.png'),
                          fit: BoxFit.scaleDown,
                        ),
                      ),
                    ),

          ...
          Column(
            ...
            children: [
              Container(
                ...
                child: Image(image: AssetImage("images/brain_one.png"),fit: BoxFit.fill,),
              ),
              SizedBox(height: 10,),
              ...
              Padding(
                ...
                child: Container(
                  child: Card(
                    color: Colors.red,
                    child: Center(
                      child: Text("\nAlzheimer's Disease, Dementias,brain cancer, mental disorders, Stroke and Transient Ischemic Attack(TIA),Epilepsy and Other Seizure Disorders.\n",style:
                      TextStyle(
                          color: Colors.white
                      ),
                  ...
                  items: [
                    Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        image: DecorationImage(
                          image: ExactAssetImage('images/brain_two.png'),
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        borderRadius: BorderRadius.circular(8.0),
                        image: DecorationImage(
                          image: ExactAssetImage('images/brain_three.png'),
                          fit: BoxFit.scaleDown,
                        ),
                      ),
                    ),
                    Container(
                      ...
                      decoration: BoxDecoration(
                        borderRadius: BorderRadius.circular(8.0),
                        image: DecorationImage(
                          image: ExactAssetImage('images/brain_four.png'),
                          fit: BoxFit.scaleDown,
                        ),
                      ),
                    ),

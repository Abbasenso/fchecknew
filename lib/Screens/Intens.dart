...
class Intens extends StatefulWidget {
  @override
  _IntensState createState() => _IntensState();
}
          ...
          Column(
            ...
            children: [
              Container(
                ...
                child: Image(image: AssetImage("images/intenstine.png"),fit: BoxFit.fill,),
              ),
              SizedBox(height: 10,),
                  ...
                  items: [
                    Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        image: DecorationImage(
                          image: ExactAssetImage('images/liver1.png'),
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        borderRadius: BorderRadius.circular(8.0),
                        image: DecorationImage(
                          image: ExactAssetImage('images/liver2.png'),
                          fit: BoxFit.scaleDown,
                        ),
                      ),
                    ),
                    Container(
                      ...
                      decoration: BoxDecoration(
                        borderRadius: BorderRadius.circular(8.0),
                        image: DecorationImage(
                          image: ExactAssetImage('images/liver3.png'),
                          fit: BoxFit.scaleDown,
                        ),
                      ),
                    ),
